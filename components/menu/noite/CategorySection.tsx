...
export function CategorySection({ category, slug, linkBase }: CategorySectionProps) {
  ...
  return (
    <section className="mb-8">
      <h2 className="font-dm-sans font-bold text-[10px] text-white/25 uppercase tracking-[0.2em] mb-3">
        {category.name}
      </h2>
      {category.items.length > 0 ? (
        ...
        <p className="font-dm-sans text-sm text-white/20 py-8 text-center">
